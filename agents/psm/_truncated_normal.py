"""agents/psm/_truncated_normal.py — VERBATIM port of PSM's TruncatedNormal.

Source: baselines/PSM/utils.py (TruncatedNormal). Copied unchanged so the
bit-exact reference-equivalence test passes. DO NOT modify the math.
"""
import torch
