...
**Architecture:** Three stages (spec `docs/superpowers/specs/2026-07-20-psmflow-v1-design.md`):
...
- Commit messages: NO Claude co-authorship line (user preference, see HANDOFF).
...
JAX_PLATFORMS=cpu .venv/bin/python tools/precompute_preimages.py \
  ...
  preimage_out=/tmp/claude-47889/-u-amsks-git-PSMFLows/5f04749b-5b9f-406e-bef7-7c58bd4a51d9/scratchpad/pre_smoke.npz
```
...
```bash
SCRATCH=/tmp/claude-47889/-u-amsks-git-PSMFLows/5f04749b-5b9f-406e-bef7-7c58bd4a51d9/scratchpad
