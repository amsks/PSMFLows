...
# Pure helpers (contrastive_loss, ortho_loss, targets_uncertainty, proto_sample,
# project_z, off_diagonal_mask, polyak_update, _plain_config, _HashableDict, _step, _soft)
# moved to utils/psm_common.py on 2026-09-04 so agents/psmflow.py could keep them after
# this file was archived. Re-exported here so this module reads as it always did.
from utils.psm_common import (  # noqa: E402,F401
    _HashableDict, _plain_config, _soft, _step, contrastive_loss, off_diagonal_mask,
    ortho_loss, polyak_update, project_z, proto_sample, targets_uncertainty,
)
